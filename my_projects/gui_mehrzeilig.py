...
def laden():
    ...
    try:
        ...
        txText.insert(1.0, "Datei nicht geoffnet")
...
buLaden = tkinter.Button(fenster, text="Aus Datei laden", command=laden, width=15)
buLaden.grid(row=2, column=0, sticky="w", padx=5, pady=5)

buSpeichern = tkinter.Button(fenster, text="In Datei speichern", command=speichern, width=15)
buSpeichern.grid(row=2, column=1, padx=5, pady=5)

buLoeschen = tkinter.Button(fenster, text="Text delete", command=loeschen, width=15)
