...
print('Hohe:', imBild.height())
print('Farbe x, y:', imBild.get(0, 0))
if not imBild.transparency_get(50, 40):
    print("Punkt ist nicht transparent")

buSchrift = tkinter.Button(fenster, text="Schrift blau", command=schrift, width=20)
buSchrift.grid(row=1, column=0, padx=10, pady=10)

buTransparent = tkinter.Button(fenster, text="Bereich transparent", command=transparent, width=20)
buTransparent.grid(row=2, column=0, padx=10, pady=10)
