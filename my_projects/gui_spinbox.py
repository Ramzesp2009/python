...
lbAuswahl.grid(row=0, column=0, padx=10, pady=10)
...
spStadt.set('Hamburg')
spStadt.grid(row=1, column=0, sticky="w", padx=10, pady=10)

spZahl = tkinter.ttk.Spinbox(fenster, from_=10, to=20, width=15, command=auswahlZahl)
spZahl.set(12)
spZahl.grid(row=2, column=0, sticky="w",padx=10, pady=10)

buAusgabe = tkinter.Button(fenster, text="Ausgabe", command=ausgabe, width=10)
buAusgabe.grid(row=3, column=0, sticky="w",padx=10, pady=10)

lbAusgabe = tkinter.Label(fenster, text="(leer)")
lbAusgabe.grid(row=4, column=0, sticky="w",padx=10, pady=10)

buEnde = tkinter.Button(fenster, text="Ende", command=ende, width=10)
buEnde.grid(row=5, column=3, sticky="w",padx=10, pady=10)
