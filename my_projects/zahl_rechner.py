...
print("Quadratwurzel van 64:", math.sqrt(64))
print("Kubikwurzel von -27:", math.cbrt(-27))
print("Ganzzahlige Quadratwurzel van 80:", math.isqrt(80))
print()

print("Naturlicher Logarithmuus von 33:", math.log(33))
...
print("Fakultet von 5:", math.factorial(5))
print("Grosster gem. Teiler von 60 und 135:", math.gcd(60, 135))
