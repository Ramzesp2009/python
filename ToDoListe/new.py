...
class MyTabView(customtkinter.CTkTabview):
    def __init__(self, master, task_manager, **kwargs):
        ...
        self.tabs = ["Переглянути завдання", "Створити завдання"]
    ...
    def create_task_tab(self):
        ...
        self.label_date = customtkinter.CTkLabel(task_tab,
                                                 text="Дата виконання:")
        ...
        self.button_save = customtkinter.CTkButton(task_tab,
                                                   text="Зберегти",
    ...
    def view_tasks_tab(self):
        ...
        # Кнопка видалення
        self.delete_button = customtkinter.CTkButton(task_tab,
