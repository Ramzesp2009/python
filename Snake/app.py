...
class Food:
    ...
    def create(self):
        number_of_colons = SIDE // SNAKE_SIZE
        x = randint(0, number_of_colons - 1) * SNAKE_SIZE
        y = randint(0, number_of_colons - 1) * SNAKE_SIZE
