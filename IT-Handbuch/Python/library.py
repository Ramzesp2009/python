...
class Genre:
    ...
    def __init__(self, title, parent=None):
        ...
        Args:
        title (str): the new genre's name
        parent (Genre):the parent genre, if any
        """
        self.title = title
        self.parent = parent
    ...
    def __str__(self):
        ...
        if self.parent is not None:
            result = f"{self.parent.__str__()} > {result}"
        return result
...
class Book:
    ...
    author (Author or list of Author objects): The book's author(s)
    ...
    def in_genre(self, genre):
        """Checks whether a specific genre is among the book's genres
...
class Ebook(Book):
    ...
    def __init__(self, title, authors=None, genre=None, year=None, tech=None):
        ...
        Args:
            tech (str, optional): The ebook's technology or file format,
        """
...
if __name__ == "__main__":
    ...
    book_windhaven = Book("Widhaven", authors=[author_martin, author_tuttle],
    ...
    for book in library.filter("genre", genre_scifi):
        print(f"- {book}")
    print()
    print("Books co-written by Lise Tuttle:")
